...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/hoholms/ProxmoxVE/refs/heads/feature/lokimain/tools/copy-data//home-assistant-container-copy-data-home-assistant-core.sh)"

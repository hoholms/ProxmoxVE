...
# Use to copy all data from a Home Assistant LXC to a Podman Home Assistant LXC
# run from the Proxmox Shell
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/hoholms/ProxmoxVE/refs/heads/feature/lokimain/tools/copy-data//home-assistant-container-copy-data-podman-home-assistant.sh)"
